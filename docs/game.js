...
var _user$project$Model$getRackByPieceColour = F2(
	function (pieceColour, model) {
		...
		switch (_p7.ctor) {
			...
			case 'Green':
				return model.greenRack;
			case 'Blue':
				return model.blueRack;
			default:
...
var _user$project$Model$getBoardSection = F2(
	function (board, boardLocation) {
		...
		switch (_p22.ctor) {
			...
			case 'TopMiddle':
				return board.topMiddle;
			case 'TopRight':
				return board.topRight;
			case 'LeftMiddle':
				return board.leftMiddle;
			case 'Middle':
				return board.middle;
			case 'RightMiddle':
				return board.rightMiddle;
			case 'BottomLeft':
				return board.bottomLeft;
			case 'BottomMiddle':
				return board.bottomMiddle;
			default:
...
var _user$project$Model$Board = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {topLeft: a, topMiddle: b, topRight: c, leftMiddle: d, middle: e, rightMiddle: f, bottomLeft: g, bottomMiddle: h, bottomRight: i};
	});
var _user$project$Model$Section = F3(
	function (a, b, c) {
		return {large: a, medium: b, small: c};
	});
var _user$project$Model$emptyRackSection = A3(_user$project$Model$Section, false, false, false);
var _user$project$Model$fullRackSection = A3(_user$project$Model$Section, true, true, true);
var _user$project$Model$Rack = F3(
	function (a, b, c) {
		return {first: a, second: b, third: c};
	});
var _user$project$Model$emptyRack = A3(_user$project$Model$Rack, _user$project$Model$emptyRackSection, _user$project$Model$emptyRackSection, _user$project$Model$emptyRackSection);
var _user$project$Model$fullRack = A3(_user$project$Model$Rack, _user$project$Model$fullRackSection, _user$project$Model$fullRackSection, _user$project$Model$fullRackSection);
var _user$project$Model$BoardId = F2(
	function (a, b) {
		return {ctor: 'BoardId', _0: a, _1: b};
	});
var _user$project$Model$BottomRight = {ctor: 'BottomRight'};
var _user$project$Model$BottomMiddle = {ctor: 'BottomMiddle'};
var _user$project$Model$BottomLeft = {ctor: 'BottomLeft'};
var _user$project$Model$RightMiddle = {ctor: 'RightMiddle'};
var _user$project$Model$Middle = {ctor: 'Middle'};
var _user$project$Model$LeftMiddle = {ctor: 'LeftMiddle'};
...
var _user$project$View$donut = F4(
	function (x, y, outerRadius, innerRadius) {
		var innerRadiusString = _elm_lang$core$Basics$toString(innerRadius);
		var outerRadiusString = _elm_lang$core$Basics$toString(outerRadius);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' m 0 ',
					_elm_lang$core$Basics$toString(0 - outerRadius)),
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(
						_elm_lang$core$Basics_ops['++'],
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' ',
								A2(_elm_lang$core$Basics_ops['++'], outerRadiusString, ' 0 1 0 1 0')))),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' Z',
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' m 0 ',
								_elm_lang$core$Basics$toString(outerRadius - innerRadius)),
							A2(
								_elm_lang$core$Basics_ops['++'],
								A2(
									_elm_lang$core$Basics_ops['++'],
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											' ',
											A2(_elm_lang$core$Basics_ops['++'], innerRadiusString, ' 0 1 1 -1 0')))),
								' Z'))))));
	});
var _user$project$View$pieceCircle = function (attributes) {
	return A2(
...
var _user$project$View$piecePath = function (attributes) {
	return A2(
...
var _user$project$View$nullSvg = _user$project$View$piecePath(
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$View$highlight = _elm_lang$core$Native_List.fromArray(
	[
		_elm_lang$svg$Svg_Attributes$stroke('white')
	]);
var _user$project$View$noHighlight = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$View$sectionHeightString = _elm_lang$core$Basics$toString(_user$project$View$sectionHeight);
var _user$project$View$halfSectionHeight = _user$project$View$sectionHeight / 2;
var _user$project$View$halfSectionHeightString = _elm_lang$core$Basics$toString(_user$project$View$halfSectionHeight);
var _user$project$View$gameWidth = 600;
var _user$project$View$widthString = _elm_lang$core$Basics$toString(_user$project$View$gameWidth);
var _user$project$View$sectionWidth = _user$project$View$gameWidth / 5;
var _user$project$View$sectionWidthString = _elm_lang$core$Basics$toString(_user$project$View$sectionWidth);
var _user$project$View$viewBoxString = A2(
	_elm_lang$core$Basics_ops['++'],
	'0 0 ',
	A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View$sectionWidthString,
		A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$View$sectionHeightString)));
var _user$project$View$halfSectionWidth = _user$project$View$sectionWidth / 2;
...
var _user$project$View$boardSectionView = F3(
	function (selectedSize, location, _p2) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$width(_user$project$View$sectionWidthString),
					_elm_lang$svg$Svg_Attributes$height(_user$project$View$sectionHeightString),
					_elm_lang$svg$Svg_Attributes$viewBox(_user$project$View$viewBoxString)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					function () {
					...
					if (_p6.ctor === 'Colour') {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Attributes$cx(_user$project$View$halfSectionWidthString),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					if (_p9.ctor === 'Colour') {
						...
						return _user$project$View$nullSvg;
					}
				}(),
					function () {
					var _p10 = _p8._1;
							...
							A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg_Events$onClick(
										_user$project$Msg$Select(
											A2(_user$project$Model$RackId, index, _user$project$Model$Small))),
										_elm_lang$svg$Svg_Attributes$cx(_user$project$View$halfSectionWidthString),
										_elm_lang$svg$Svg_Attributes$cy(_user$project$View$halfSectionWidthString),
										_elm_lang$svg$Svg_Attributes$r(
										_elm_lang$core$Basics$toString((_user$project$View$halfSectionWidth * 1) / 9)),
...
var _user$project$View$rackSectionView = A3(_user$project$View$playerRackSectionViewHelper, _user$project$View$noHighlight, _user$project$View$noHighlight, _user$project$View$noHighlight);
var _user$project$View$playerRackSectionView = F3(
	function (maybeRackId, index, ringDescription) {
			...
			if (_p12.ctor === 'Nothing') {
				...
				if (_elm_lang$core$Native_Utils.eq(index, _p12._0._0)) {
					...
					switch (_p13.ctor) {
						...
						case 'Medium':
							return A3(_user$project$View$playerRackSectionViewHelper, _user$project$View$noHighlight, _user$project$View$highlight, _user$project$View$noHighlight);
						default:
							return A3(_user$project$View$playerRackSectionViewHelper, _user$project$View$noHighlight, _user$project$View$noHighlight, _user$project$View$highlight);
					}
				} else {
					return A3(_user$project$View$playerRackSectionViewHelper, _user$project$View$noHighlight, _user$project$View$noHighlight, _user$project$View$noHighlight);
				}
		...
		return A2(curriedHelper, index, ringDescription);
	});
var _user$project$View$yellow = '#EFEFAB';
var _user$project$View$blue = '#ABCDEF';
var _user$project$View$green = '#CDEFAB';
var _user$project$View$red = '#EFABCD';
var _user$project$View$Blank = {ctor: 'Blank'};
var _user$project$View$Colour = function (a) {
	return {ctor: 'Colour', _0: a};
};
var _user$project$View$descriptionFromRack = F2(
	function (colour, b) {
...
var _user$project$View$descriptionFromBoardState = function (boardState) {
	...
	if (_p14.ctor === 'PieceType') {
		switch (_p14._0.ctor) {
			...
			case 'Green':
				return _user$project$View$Colour(_user$project$View$green);
			case 'Blue':
				return _user$project$View$Colour(_user$project$View$blue);
			default:
				return _user$project$View$Colour(_user$project$View$yellow);
		}
	} else {
		return _user$project$View$Blank;
	}
};
var _user$project$View$RingsDescription = F3(
	function (a, b, c) {
		return {ctor: 'RingsDescription', _0: a, _1: b, _2: c};
	});
var _user$project$View$rackSectionDescription = F2(
	function (colour, section) {
		return A3(
			_user$project$View$RingsDescription,
			A2(_user$project$View$descriptionFromRack, colour, section.large),
			A2(_user$project$View$descriptionFromRack, colour, section.medium),
			A2(_user$project$View$descriptionFromRack, colour, section.small));
	});
var _user$project$View$rackDescription = F2(
	function (colour, rack) {
		return _elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$View$rackSectionDescription, colour, rack.first),
				A2(_user$project$View$rackSectionDescription, colour, rack.second),
				A2(_user$project$View$rackSectionDescription, colour, rack.third)
			]);
	});
var _user$project$View$boardSectionDescription = function (section) {
	return A3(
		_user$project$View$RingsDescription,
		_user$project$View$descriptionFromBoardState(section.large),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							A2(_user$project$View$rackDescription, _user$project$View$red, model.redRack))),
						A5(
						_debois$elm_mdl$Material_Button$render,
						_user$project$Msg$Mdl,
						_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$List$indexedMap,
							_user$project$View$rackSectionView,
							A2(_user$project$View$rackDescription, _user$project$View$yellow, model.yellowRack)))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Otrio$subscriptions = _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none);
var _user$project$Otrio$init = {ctor: '_Tuple2', _0: _user$project$Model$defaultState, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Otrio$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Otrio$init, update: _user$project$Update$update, subscriptions: _user$project$Otrio$subscriptions, view: _user$project$View$view})
};

var Elm = {};
Elm['Otrio'] = Elm['Otrio'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Otrio'], 'Otrio', typeof _user$project$Otrio$main === 'undefined' ? null : _user$project$Otrio$main);
